...
contract CastlesArbi is ERC721Enumerable, ReentrancyGuard, Ownable {
     ...
     * in child contracts.
     */
    string private baseURI = "https://castles-arbitrum-nft.vercel.app/api/castle/";
    ...
    constructor() ERC721("CastlesArbiGenOne", "CastlesArbiGenOne") Ownable() {}
}