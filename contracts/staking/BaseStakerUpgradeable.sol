...
contract BaseStakerUpgradeable is ERC1155HolderUpgradeable, ERC721HolderUpgradeable {
    struct LockInfo {
        uint256 lockStart;
        uint256 lockEnd;
    ...
    function _stakeERC1155ForUser(
        ...
        ERC1155Upgradeable tokenContract = ERC1155Upgradeable(_collection);
    ...
    function _stakeFungibleForUser(
        ...
        ERC20Upgradeable tokenContract = ERC20Upgradeable(_collection);
    ...
    function _stakeERC721ForUser(
        ...
        ERC721Upgradeable tokenContract = ERC721Upgradeable(_collection);
     ...
     * @param _amount The number of tokens to unstake
     */
    function _unstakeFungible(address _collection, uint256 _amount) internal {
        require(
